...
<body>
    ...
    <nav class="navbar mnav navbar-expand-lg navbar-dark static-top" style="background-color: #5a0533;padding:20px;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        <div class="container" style="font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
            <a style="margin-left:0%;padding-left:0px" class="navbar-brand" href="http://jaincollegeofengineeringhubli.com">
                <h3 class="mh3">VTU</h3>
            </a>
    ...
    <div class=" mcontainer">
        <form name="register" method="post" class="myform" action="" enctype="multipart/form-data">
            ...
            <?php echo @$err; ?>
            <hr class="mhr" color="black" height="10px" />
            <table width="100%">
                <tr>
                    <td>
                    ...
                    <td class="td1">
                        <input type="text" autocomplete="off" name="fname" placeholder="" class="required" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="lname" autocomplete="off" placeholder="" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="text" name="USN" autocomplete="off" placeholder="" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="email" name="mail" autocomplete="off" placeholder="" required />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <select name="dept" class="select1" autocomplete="off" placeholder="" required>
                ...
                <tr>
                    ...
                    <td class="td1">
                        <input type="phone" autocomplete="off" name="phone" id="phone" placeholder="" />
                    </td>
                </tr>
